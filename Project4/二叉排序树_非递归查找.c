...
////
////}
//BiTree SearchBST(BiTree T, KeyType e)//二叉排序树非递归查找
//{
//	BiTree q;
//	q = T;
//	
...
//			else if (q->data > e)return q = q->Lchild;
//			else q = q->Rchild;
//		}
//		return NULL;
//	
...
//	printf("0代表该节点为空\n");
//	int i, j, Count = 0;
//	BiTree tree=NULL,temp = NULL;
//	CreateBST(&tree);//创建树,初始化序列：1 2 3 4 5 6 7 8       999
//					  //复制粘贴到控制台窗口即可
...
//	for (int i = 0; i < num; i++)
//	{
//		temp = SearchBST(tree, a[i]);
//		if (temp != NULL)printf("%d is found",a[i]);
//		else printf("%d is not found", a[i]);
//		if (i <num-1)printf("\n");
//	}
//
//
